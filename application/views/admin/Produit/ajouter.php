    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <strong>Ajouter une produit d'accueil</strong>
            ...
            <?php endif; ?>
               ...
               <div class="form-group col-md-6 <?php if(form_error('product')) { echo 'has-error'; } ?>">
                ...
                <div class="">
                  <?= form_input(array('name' => 'product', 'placeholder' => 'Nom de Produit', 'id' => 'product_code', 'class' => 'form-control', 'value' => set_value('product'))); ?>
			  ...
			  <div class="form-group col-md-6 <?php if(form_error('desc')) { echo 'has-error'; } ?>">
                ...
                <div class="">
                  <?= form_input(array('name' => 'desc', 'placeholder' => 'Description Courte', 'id' => 'desc', 'class' => 'form-control', 'value' => set_value('desc'))); ?>
...
<div class="form-group col-md-6 <?php if(form_error('desl')) { echo 'has-error'; } ?>">
                ...
                <div class="">
                  <?= form_textarea(array('name' => 'desl', 'placeholder' => 'Description Longue', 'id' => 'desl', 'class' => 'form-control', 'value' => set_value('desl'))); ?>
