<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
            	<?= form_open( 'admin/utilisateur/ajouter' ); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4 <?php if(form_error('role')) { echo 'has-error'; } ?>">
                            ...
                            <div class="">
                            	<?= form_dropdown('role', $roles, '', array('id' =>'role', 'class' =>'form-control')); ?>
    				...
    				<div class="row">
    					<div class="form-group col-md-6 <?php if(form_error('identifiant')) { echo 'has-error'; } ?>">
                            ...
                            <div class="">
                            	<?= form_input(array('name' => 'identifiant', 'placeholder' => 'Identifiant', 'id' => 'identifiant', 'class' => 'form-control', 'value' => set_value('identifiant'))); ?>
                        ...
                        <div class="form-group col-md-3 <?php if(form_error('mot_de_passe')) { echo 'has-error'; } ?>">
                            ...
                            <div class="">
                            	<?= form_input(array('type' => 'password', 'name' => 'mot_de_passe', 'placeholder' => 'Mot de passe', 'id' => 'mot_de_passe', 'class' => 'form-control', 'value' => set_value('mot_de_passe'))); ?>
                        ...
                        <div class="form-group col-md-3 <?php if(form_error('mot_de_passe_check')) { echo 'has-error'; } ?>">
                            ...
                            <div class="">
                            	<?= form_input(array('type' => 'password', 'name' => 'mot_de_passe_check', 'placeholder' => 'Mot de passe', 'id' => 'mot_de_passe_check', 'class' => 'form-control', 'value' => set_value('mot_de_passe_check'))); ?>
