  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <?= form_open( 'admin/client/ajouter' ); ?>
        ...
        <div class="row">
          ...
          <div class="form-group col-md-4 <?php if(form_error('email')) { echo 'has-error'; } ?>">
            ...
            <div class="">
              <?= form_input(array('name' => 'email', 'placeholder' => 'Adresse e-mail', 'id' => 'email', 'class' => 'form-control', 'value' => set_value('email'))); ?>
        ...
        <div class="row">
          ...
          <div class="form-group col-md-2 <?php if(form_error('civilite')) { echo 'has-error'; } ?>">
            ...
            <div class="">
            	<?= form_dropdown('civilite', array('Mr' => 'Mr', 'Mme' => 'Mme', 'Mlle' => 'Mlle'), '', array('id' =>'civilite', 'class' =>'form-control')); ?>
            ...
            <div class="">
            	<?= form_input(array('name' => 'nom', 'placeholder' => 'Nom', 'id' => 'nom', 'class' => 'form-control', 'value' => set_value('nom'))); ?>
          ...
          <div class="form-group col-md-5 <?php if(form_error('prenom')) { echo 'has-error'; } ?>">
            ...
            <div class="">
            	<?= form_input(array('name' => 'prenom', 'placeholder' => 'Prénom', 'id' => 'prenom', 'class' => 'form-control', 'value' => set_value('prenom'))); ?>
        ...
        <div class="row">
          ...
          <div class="form-group col-md-6 <?php if(form_error('telephone')) { echo 'has-error'; } ?>">
            ...
            <div class="">
            	<?= form_input(array('name' => 'telephone', 'placeholder' => 'Téléphone', 'id' => 'telephone', 'class' => 'form-control', 'value' => set_value('telephone'))); ?>
            ...
            <div class="">
            	<?= form_input(array('name' => 'mobile', 'placeholder' => 'Mobile', 'id' => 'mobile', 'class' => 'form-control', 'value' => set_value('mobile'))); ?>
        ...
        <div class="row">
          ...
          <div class="form-group col-md-8 <?php if(form_error('adresse')) { echo 'has-error'; } ?>">
            ...
            <div class="">
            	<?= form_input(array('name' => 'adresse', 'placeholder' => 'Adresse', 'id' => 'adresse', 'class' => 'form-control', 'value' => set_value('adresse'))); ?>
          ...
          <div class="form-group col-md-4 <?php if(form_error('code_postal')) { echo 'has-error'; } ?>">
            ...
            <div class="">
            	<?= form_input(array('name' => 'code_postal', 'placeholder' => 'Code postal', 'id' => 'postal', 'class' => 'form-control', 'value' => set_value('code_postal'))); ?>
        ...
        <div class="row">
          <div class="form-group col-md-10 <?php if(form_error('complement')) { echo 'has-error'; } ?>">
          	<?= form_label('Complement *', 'complement', array('class' => 'form-control-label')); ?>
            <div class="">
            	<?= form_input(array('name' => 'complement', 'placeholder' => 'Complement', 'id' => 'complement', 'class' => 'form-control', 'value' => set_value('complement'))); ?>
              <?= form_error('complement', '<small><span class="help-block text-danger">', '</span></small>'); ?>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="form-group col-md-6 <?php if(form_error('ville')) { echo 'has-error'; } ?>">
            ...
            <div class="">
            	<?= form_input(array('name' => 'ville', 'placeholder' => 'Ville', 'id' => 'ville', 'class' => 'form-control', 'value' => set_value('ville'))); ?>
